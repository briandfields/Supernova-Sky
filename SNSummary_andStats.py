...
cs = ax1.contourf(-l_radian,b_radian,dP_dOmega_Ia,levels=levs,colors=colors_ia,alpha=alpha_transp)
...
cs = ax1.contourf(-l_radian,b_radian,dP_dOmega_CC,levels=levs,colors=colors_cc,alpha=alpha_transp)
...
if (PlotEquatorial):
    ...
    cs = ax1eq.contourf(-ra_radian,dec_radian,dP_dOmega_Ia,levels=levs_eq,colors=colors_ia,alpha=alpha_transp)
    ...
    cs = ax1eq.tricontourf(-ra_radian,dec_radian,dP_dOmega_CC,levels=levs_eq,colors=colors_cc,alpha=alpha_transp)
...
cs = ax2.contourf(-l_radian,b_radian,dP_dOmega_Ia,levels=levs,colors=colors_ia,alpha=alpha_transp)
...
cs = ax2.contourf(-l_radian,b_radian,dP_dOmega_CC,levels=levs,colors=colors_cc,alpha=alpha_transp)
...
if (PlotSNRKDE):
    ...
    plt.contour(xi, yi, zi.reshape(xi.shape), levels=levs_SNR, colors=colors_SNR, linestyles=linesty_SNR)
...
plt.scatter(-long_SNR, lat_SNR, facecolors='black', edgecolors='black', zorder=5,alpha=0.5, marker=".")
